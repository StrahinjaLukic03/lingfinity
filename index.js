...
function Choice(checkbox){
	...
	if(checkbox.checked){
		...
		document.getElementById("modeImg").className = "animate__animated animate__fadeInLeft";
		...
		document.getElementById("modeImg").className = "animate__animated animate__fadeInRight";
